...
<body>
    ...
    <a href="../php/newstarter.php" target="ventanatablas" class="atabla">AGREGAR STARTER</a>
    <a href="../php/tablaprod.php" target="ventanatablas" class="atabla">PRODUCTOS</a>
    <a href="../php/newprod.php" target="ventanatablas" class="atabla">AGREGAR PRODUCTO</a>
    </div>
