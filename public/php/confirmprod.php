...
<body id="tablas">
    <div class="estilomod">
        ...
        <div class="btnborrar">
            <a href="borrarprod.php?id=<?php echo $id; ?>" target="ventanatablas" class="atablaborrar">ELIMINAR</a>
            <a href="tablaprod.php" target="ventanatablas" class="atabla">CANCELAR</a>
        </div>
    </div>
</body>